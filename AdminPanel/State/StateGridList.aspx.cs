...
public partial class AllList_AdminPanel_State_StateGridList : System.Web.UI.Page
{
    #region Load method
        ...
        using (SqlConnection ObjConn = new SqlConnection(ConfigurationManager.ConnectionStrings["MultiUserAddressBookCoonectionString"].ConnectionString))
        {
            try
            {
                ...
                using (SqlCommand ObjCmd = ObjConn.CreateCommand())
                {
                    ...
                    ObjCmd.CommandText = "PR_State_LeftOuterJoinByUserID";
    ...
    {
        Response.Redirect("~/AllList/AdminPanel/State/StateAddEdit.aspx");
    }
