<%@ Page Title="" Language="C#" MasterPageFile="~/AllList/Content/MasterPage.master" AutoEventWireup="true" CodeFile="AboutTrust.aspx.cs" Inherits="AllList_AdminPanel_AboutTrust" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">

     <br /><h1>About  &nbsp; Trust</h1><br />
    <br />About <strong>Shree G. N. Patel Education and Charitable Trust</strong><br/><br/><br />
