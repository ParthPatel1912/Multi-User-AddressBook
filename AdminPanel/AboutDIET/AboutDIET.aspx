<%@ Page Title="" Language="C#" MasterPageFile="~/AllList/Content/MasterPage.master" AutoEventWireup="true" CodeFile="AboutDIET.aspx.cs" Inherits="AllList_AdminPanel_AboutDIET" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">

      <br /><h1>About &nbsp;  Institute</h1><br />

    <br />About <strong>Darshan Institute of Engineering & Technology</strong><br/><br/><br />
